...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000,
                                    step=1000, marks={0: '0', 10000: '10000'},
                                    value=[min_payload, max_payload]),
                                # TASK 4: Add a scatter chart to show the correlation between payload and launch success
                                html.H2('Correlation between Payload and selected launch site'),
...
def get_charts(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        fig1 = px.pie(filtered_df[mask],
        values='class',
        names='Launch Site',
        title='Total Successful launches by site')

        fig3 = px.scatter(filtered_df[mask], x="Payload Mass (kg)", y="class",
        ...
        fig2 = px.pie(filtered_df2[mask],
        names='class',
        title='total successful launches for site ' + entered_site)

        fig4 = px.scatter(filtered_df2[mask], x="Payload Mass (kg)", y="class",
            color="Booster Version Category")
